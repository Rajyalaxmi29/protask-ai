    ...
    return (
      ...
      `}</style>
            ...
            <MotionComponent
                ...
                onClick={onClick}
                className={cn(
                    "group relative isolate overflow-hidden rounded-full bg-[#030303] px-8 py-3 text-sm font-medium text-white transition-all hover:bg-[#0a0a0a]",
            ...
            >
                ...
                <div className="absolute inset-[1px] -z-10 rounded-full bg-[#030303]" />
